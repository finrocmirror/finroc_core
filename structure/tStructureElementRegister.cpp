...
finroc::util::tString& tStructureElementRegister::GetAutoGeneratedPortName(tFrameworkElement* parent, int port_index)
{
  ...
  util::tString s(rrlib::serialization::tDataTypeBase::GetDataTypeNameFromRtti(typeid(*parent).name()));
  if (s.Contains("<"))
  {
