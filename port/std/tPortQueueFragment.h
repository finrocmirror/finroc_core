...
#ifndef CORE__PORT__STD__TPORTQUEUEFRAGMENT_H
 ...
 */
template<typename T>
class tPortQueueFragment : public util::tQueueFragment<tPortDataReference, tPortQueueElement>
{
public:
   ...
   * \return Next element in QueueFragment
   */
  inline T* DequeueUnsafe()
  {
    return static_cast<T*>(Dequeue()->GetData());
  }
...
#endif // CORE__PORT__STD__TPORTQUEUEFRAGMENT_H
