...
#ifndef CORE__PORT__RPC__METHOD__TPORT2METHOD_H
#define CORE__PORT__RPC__METHOD__TPORT2METHOD_H
...
public:
   ...
   */
  R Call(tInterfaceClientPort* port, P1 p1, P2 p2, int net_timeout = -1);
   ...
   */
  void CallAsync(const tInterfaceClientPort* port, tAsyncReturnHandler<R>* handler, P1 p1, P2 p2, int net_timeout = -1, bool force_same_thread = false);
...
#endif // CORE__PORT__RPC__METHOD__TPORT2METHOD_H
