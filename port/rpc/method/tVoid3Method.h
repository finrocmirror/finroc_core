...
#ifndef core__port__rpc__method__tVoid3Method_h__
#define core__port__rpc__method__tVoid3Method_h__
...
class tVoid3Method : public tAbstractVoidMethod
{
public:
   ...
   */
  tVoid3Method(tPortInterface& port_interface, const util::tString& name, const util::tString& p1_name, const util::tString& p2_name, const util::tString& p3_name, bool handle_in_extra_thread);
   ...
   */
  void Call(tInterfaceClientPort port, tP1Arg p1, tP2Arg p2, tP3Arg p3, bool force_same_thread = false);
...
#include "core/port/rpc/method/tVoid3Method.hpp"

#endif // core__port__rpc__method__tVoid3Method_h__
