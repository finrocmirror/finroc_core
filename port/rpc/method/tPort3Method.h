...
#ifndef core__port__rpc__method__tPort3Method_h__
#define core__port__rpc__method__tPort3Method_h__
...
class tPort3Method : public tAbstractNonVoidMethod
{
public:
  ...
  typedef typename tArg<P3>::type tP3Arg;
   ...
   */
  tPort3Method(tPortInterface& port_interface, const util::tString& name, const util::tString& p1_name, const util::tString& p2_name, const util::tString& p3_name, bool handle_in_extra_thread, int default_net_timeout = cDEFAULT_NET_TIMEOUT);
   ...
   */
  R Call(tInterfaceClientPort port, tP1Arg p1, tP2Arg p2, tP3Arg p3, int net_timeout = -1);
   ...
   */
  void CallAsync(const tInterfaceClientPort* port, tAsyncReturnHandler<R>* handler, tP1Arg p1, tP2Arg p2, tP3Arg p3, int net_timeout = -1, bool force_same_thread = false);
...
#include "core/port/rpc/method/tPort3Method.hpp"

#endif // core__port__rpc__method__tPort3Method_h__
