...
public:
   ...
   */
  R Call(tInterfaceClientPort port, P1 p1, P2 p2, P3 p3, int net_timeout = -1);
   ...
   */
  void CallAsync(const tInterfaceClientPort* port, tAsyncReturnHandler<R>* handler, P1 p1, P2 p2, P3 p3, int net_timeout = -1, bool force_same_thread = false);
