...
template<typename HANDLER, typename P1, typename P2, typename P3, typename P4>
void tVoid4Method<HANDLER, P1, P2, P3, P4>::Call(tInterfaceClientPort port, tP1Arg p1, tP2Arg p2, tP3Arg p3, tP4Arg p4, bool force_same_thread)
{
  //1
  assert((HasLock(p1)));  //2
  assert((HasLock(p2)));  //3
...
template<typename HANDLER, typename P1, typename P2, typename P3, typename P4>
void tVoid4Method<HANDLER, P1, P2, P3, P4>::ExecuteFromMethodCallObject(tMethodCall* call, tAbstractMethodCallHandler* handler, tAbstractAsyncReturnHandler* ret_handler)
{
...
template<typename HANDLER, typename P1, typename P2, typename P3, typename P4>
void tVoid4Method<HANDLER, P1, P2, P3, P4>::ExecuteFromMethodCallObject(tMethodCall* call, const HANDLER& handler)
{
