...
template<typename HANDLER>
void tVoid0Method<HANDLER>::Call(tInterfaceClientPort port, bool force_same_thread)
{
...
template<typename HANDLER>
void tVoid0Method<HANDLER>::ExecuteFromMethodCallObject(tMethodCall* call, tAbstractMethodCallHandler* handler, tAbstractAsyncReturnHandler* ret_handler)
{
...
template<typename HANDLER>
void tVoid0Method<HANDLER>::ExecuteFromMethodCallObject(tMethodCall* call, const HANDLER& handler)
{
