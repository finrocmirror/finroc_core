...
class tVoid2Method : public tAbstractVoidMethod
{
public:
   ...
   */
  tVoid2Method(tPortInterface& port_interface, const util::tString& name, const util::tString& p1_name, const util::tString& p2_name, bool handle_in_extra_thread);
   ...
   */
  void Call(tInterfaceClientPort port, tP1Arg p1, tP2Arg p2, bool force_same_thread = false);
