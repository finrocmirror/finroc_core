...
#ifndef CORE__PORT__RPC__METHOD__TMETHOD0HANDLER_H
#define CORE__PORT__RPC__METHOD__TMETHOD0HANDLER_H
...
template<typename R>
class tMethod0Handler : public util::tInterface
{
public:
   ...
   */
  virtual R HandleCall(const tAbstractMethod* method) = 0;
...
#endif // CORE__PORT__RPC__METHOD__TMETHOD0HANDLER_H
