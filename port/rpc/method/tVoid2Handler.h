...
#ifndef CORE__PORT__RPC__METHOD__TVOID2HANDLER_H
#define CORE__PORT__RPC__METHOD__TVOID2HANDLER_H
...
class tVoid2Handler : public util::tInterface
{
public:
   ...
   */
  virtual void HandleVoidCall(const tAbstractMethod* method, P1& p1, P2& p2) = 0;
...
#endif // CORE__PORT__RPC__METHOD__TVOID2HANDLER_H
