...
#ifndef core__port__rpc__method__tPort4Method_h__
#define core__port__rpc__method__tPort4Method_h__
...
class tPort4Method : public tAbstractNonVoidMethod
{
public:
   ...
   */
  tPort4Method(tPortInterface& port_interface, const util::tString& name, const util::tString& p1_name, const util::tString& p2_name, const util::tString& p3_name, const util::tString& p4_name, bool handle_in_extra_thread, int default_net_timeout = cDEFAULT_NET_TIMEOUT);
...
#include "core/port/rpc/method/tPort4Method.hpp"

#endif // core__port__rpc__method__tPort4Method_h__
