...
#ifndef CORE__PORT__RPC__METHOD__TVOID4HANDLER_H
#define CORE__PORT__RPC__METHOD__TVOID4HANDLER_H
...
class tVoid4Handler : public util::tInterface
{
public:
   ...
   */
  virtual void HandleVoidCall(const tAbstractMethod* method, P1& p1, P2& p2, P3& p3, P4& p4) = 0;
...
#endif // CORE__PORT__RPC__METHOD__TVOID4HANDLER_H
