...
#ifndef core__port__rpc__method__tPort0Method_h__
#define core__port__rpc__method__tPort0Method_h__
...
class tPort0Method : public tAbstractNonVoidMethod
{
public:
   ...
   */
  tPort0Method(tPortInterface& port_interface, const util::tString& name, bool handle_in_extra_thread, int default_net_timeout = cDEFAULT_NET_TIMEOUT);
   ...
   */
  void CallAsync(const tInterfaceClientPort* port, tAsyncReturnHandler<R>* handler, int net_timeout = -1, bool force_same_thread = false);
...
#include "core/port/rpc/method/tPort0Method.hpp"

#endif // core__port__rpc__method__tPort0Method_h__
