...
#ifndef CORE__PORT__RPC__METHOD__TASYNCRETURNHANDLER_H
#define CORE__PORT__RPC__METHOD__TASYNCRETURNHANDLER_H
...
#endif // CORE__PORT__RPC__METHOD__TASYNCRETURNHANDLER_H
