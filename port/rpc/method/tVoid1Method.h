...
#ifndef core__port__rpc__method__tVoid1Method_h__
#define core__port__rpc__method__tVoid1Method_h__
...
class tVoid1Method : public tAbstractVoidMethod
{
public:
   ...
   */
  tVoid1Method(tPortInterface& port_interface, const util::tString& name, const util::tString& p1_name, bool handle_in_extra_thread);
...
#include "core/port/rpc/method/tVoid1Method.hpp"

#endif // core__port__rpc__method__tVoid1Method_h__
