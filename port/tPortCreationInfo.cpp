...
tPortCreationInfo::tPortCreationInfo(const util::tString& description_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_, tUnit* u) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(u),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const rrlib::serialization::tDataTypeBase& data_type_, int flags_) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const rrlib::serialization::tDataTypeBase& data_type_, int flags_, bool manages_ports_) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& dt) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(16),
...
tPortCreationInfo::tPortCreationInfo(const util::tString& description_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_, int q_size) :
    send_buffer_size(-1),
    alt_send_buffer_size(-1),
    unit(&(tUnit::cNO_UNIT)),
    max_queue_size(q_size),
...
tPortCreationInfo tPortCreationInfo::Derive(const util::tString& new_description, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& type)
{
  tPortCreationInfo pci2(*this);
  pci2.description = new_description;
  pci2.parent = parent_;
...
tPortCreationInfo tPortCreationInfo::Derive(const rrlib::serialization::tDataTypeBase& type)
{
  tPortCreationInfo pci2(*this);
  pci2.data_type = type;
  return pci2;
