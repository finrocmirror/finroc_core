...
public:
  ...
  tPortCreationInfo(const util::tString& description_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_);

  tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_);

  tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_, tUnit* u);

  tPortCreationInfo(const util::tString& description_, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& data_type_);
  ...
  tPortCreationInfo(const rrlib::serialization::tDataTypeBase& data_type_, int flags_);

  tPortCreationInfo(const rrlib::serialization::tDataTypeBase& data_type_, int flags_, bool manages_ports_);
  ...
  tPortCreationInfo(tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& dt);

  tPortCreationInfo(const util::tString& description_, int flags_, int q_size);

  tPortCreationInfo(const util::tString& description_, const rrlib::serialization::tDataTypeBase& data_type_, int flags_, int q_size);
  ...
  tPortCreationInfo Derive(const util::tString& new_description, tFrameworkElement* parent_, const rrlib::serialization::tDataTypeBase& type);

  tPortCreationInfo Derive(const rrlib::serialization::tDataTypeBase& type);
