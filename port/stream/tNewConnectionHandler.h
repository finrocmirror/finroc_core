...
#ifndef core__port__stream__tNewConnectionHandler_h__
#define core__port__stream__tNewConnectionHandler_h__
...
#endif // core__port__stream__tNewConnectionHandler_h__
