...
::std::tr1::shared_ptr<tConstant> tConstant::cNO_MIN_TIME_LIMIT;
::std::tr1::shared_ptr<tConstant> tConstant::cNO_MAX_TIME_LIMIT;

tConstant::tConstant(const util::tString& name, tCoreNumber value_) :
    ...
    unit(value_.GetUnit())
{
  ...
  {
    throw util::tRuntimeException("Constants not allowed as unit");
  }
