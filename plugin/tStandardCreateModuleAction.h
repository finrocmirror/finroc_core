...
#ifndef core__plugin__tStandardCreateModuleAction_h__
#define core__plugin__tStandardCreateModuleAction_h__
...
#endif // core__plugin__tStandardCreateModuleAction_h__
