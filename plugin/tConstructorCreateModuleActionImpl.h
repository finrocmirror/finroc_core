...
#define CONSTRUCTORCREATEMODULEACTIONIMPL(param...) \
  ...
  public:\
    ...
    static tFrameworkElement* CreateModuleImpl(const base* b, tFrameworkElement* parent, const util::tString& name, tConstructorParameters* p) {\
...
public:
  ...
  static tFrameworkElement* CreateModuleImpl(const base* b, tFrameworkElement* parent, const util::tString& name, tConstructorParameters* p)
  {
    return new MODULE(parent, name, b->GetP1(p), b->GetP2(p), b->GetP3(p), b->GetP4(p), b->GetP5(p), b->GetP6(p), b->GetP7(p), b->GetP8(p), b->GetP9(p), b->GetP10(p), b->GetP11(p), b->GetP12(p));
  }
};
...
return new MODULE(parent, name, b->GetP1(p), b->GetP2(p), b->GetP3(p), b->GetP4(p), b->GetP5(p), b->GetP6(p), b->GetP7(p), b->GetP8(p), b->GetP9(p), b->GetP10(p), b->GetP11(p));
}
};
...
return new MODULE(parent, name, b->GetP1(p), b->GetP2(p), b->GetP3(p), b->GetP4(p), b->GetP5(p), b->GetP6(p), b->GetP7(p), b->GetP8(p), b->GetP9(p), b->GetP10(p));
}
};
