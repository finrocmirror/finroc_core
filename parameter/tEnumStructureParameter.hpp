...
{
template<typename E>
tEnumStructureParameter<E>::tEnumStructureParameter(const util::tString& name, E default_value, bool constructor_prototype, ::std::tr1::shared_ptr<util::tSimpleList<util::tString> > string_constants_) :
