...
{
template<typename E>
tEnumStructureParameter<E>::tEnumStructureParameter(const util::tString& name, bool constructor_prototype, E default_value, ::std::tr1::shared_ptr<util::tSimpleList<util::tString> > string_constants_) :
...
template<typename E>
tEnumStructureParameter<E>::tEnumStructureParameter(const util::tString& name, E default_value, const util::tString& string_constants_) :
...
template<typename E>
void tEnumStructureParameter<E>::Set(E default_value)
{
