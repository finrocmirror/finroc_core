...
#ifndef core__finstructable__tGroup_h__
#define core__finstructable__tGroup_h__
...
public:
  ...
  tGroup(tFrameworkElement* parent, const util::tString& name, uint flags = 0);
...
#endif // core__finstructable__tGroup_h__
