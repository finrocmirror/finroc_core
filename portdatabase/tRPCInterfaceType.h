...
#ifndef core__portdatabase__tRPCInterfaceType_h__
#define core__portdatabase__tRPCInterfaceType_h__
...
public:
   ...
   */
  tRPCInterfaceType(const util::tString& name, tPortInterface* methods);
...
#endif // core__portdatabase__tRPCInterfaceType_h__
