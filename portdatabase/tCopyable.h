...
#ifndef CORE__PORTDATABASE__TCOPYABLE_H
#define CORE__PORTDATABASE__TCOPYABLE_H
 ...
 */
template<typename T>
class tCopyable : public util::tInterface
{
public:
   ...
   */
  virtual void CopyFrom(const T& source) = 0;
...
#endif // CORE__PORTDATABASE__TCOPYABLE_H
